...
class _EditProfileState extends State<EditProfile> {
  ...
  void updateUser() async {
    User user = User.withId(widget.currentUser.id, textName.text,
        textEmail.text, imgUrl, widget.currentUser.password, textPhone.text);
  ...
  void initState() {
    ...
    if (widget.currentUser.image != null) {
      imgUrl = widget.currentUser.image;
    }
    ...
    return BlocListener<UserBloc, ProfileState>(
        listener: (context, state) {
          if (state is ImageFail) {
            ...
            util.errorToast("Failed to update !");
          } else if (state is UserSuccess) {
            util.successToast("Data successfully updated !");
          }
        },
